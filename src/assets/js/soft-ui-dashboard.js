...
const sidenavColor = document.querySelector("#side-nav-bar aside");
...
function navbarColorOnResize() {
  if (window.innerWidth > 1200) {
      ...
      sidenavColor.classList.remove('bg-white');
    
  } else {
    sidenavColor.classList.add('bg-white');
    sidenavColor.classList.remove('bg-transparent');
  }
}  */
/* function navbarColorOnResize() {
  if (window.innerWidth > 1200) {
